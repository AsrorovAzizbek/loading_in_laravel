...
@section('log')
            <div class="signup-form">
                ...
                <form method="POST" action="/student/{id}" class="register-form" id="register-form">
                    @csrf
                    ...
                    <div class="form-group form-button">
                        <button class="form-submit"><a href="#" style="color:white; text-decoration:none;">Teacher</a></button>
                        <button name="teacher" id="teacher" class="form-submit">Student</button>
                    </div>
                </form>
            </div>
